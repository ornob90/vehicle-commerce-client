...
const Banner = () => {
  return (
    <Container className="grid grid-cols-1 md:grid-cols-5 min-h-[300px] pt-14 bg-gradient-to-r from-white to-[#FFEDEA] ">
      <div className=" md:col-span-2 flex flex-col justify-center gap-4 w-[90%] mx-auto">
        ...
        <div>
          <Button className="bg-[#FF4D30] text-white px-8 py-3 font-medium rounded-sm">
            View Brands
          </Button>
        </div>
      </div>
